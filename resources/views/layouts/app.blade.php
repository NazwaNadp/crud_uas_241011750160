...
<head>
    ...
    <title>@yield('title', 'Purely Dessert')</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navMain">
                <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-2">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary btn-sm mt-2 mt-lg-0 position-relative" href="{{ route('keranjang.index') }}">
                    ...
                    <li class="nav-item">
                        @auth
                            <a class="btn btn-brand btn-sm mt-2 mt-lg-0" href="{{ route('dashboard') }}">
                                <i class="fa-solid fa-gauge me-1"></i> Dashboard
                            </a>
                        @else
                            <a class="btn btn-outline-secondary btn-sm mt-2 mt-lg-0" href="{{ route('login') }}">
    ...
    <footer class="py-4 mt-5">
        <div class="container text-center small">
            <p class="mb-0">&copy; {{ date('Y') }} Manis Dessert House &mdash; UAS Rekayasa Web, Universitas Pamulang</p>
        </div>
    </footer>
